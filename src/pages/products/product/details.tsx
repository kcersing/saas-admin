...
function Details({ props }) {
  ...
  let cardProperty = ""
  if (props.cardProperty !== null){
    cardProperty = <CardPropertyDetails card={props.cardProperty} />
  }
  let courseProperty = ""
  if (props.courseProperty !== null){
    courseProperty = <CourseProperty card={props.courseProperty} />
  }
  let classProperty = ""
  if (props.classProperty !== null){
    classProperty = <ClassProperty card={props.classProperty} />
  }
